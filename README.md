...
This repository provides the scripts and notebooks, as well as the required auxiliary products and datasets, supporting the reproducilibility and reusability of the Atlas, as described in the following schema and table of contents.
